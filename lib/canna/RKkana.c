 ...
 * 	shift jis --> euc 
 */
// RK/kana.c, canna/RKkana.c の両方で定義されている.
// canna/romaji.c で使われている.
int
...
RkwMapPhonogram(struct RkRxDic *romaji, cannawc *dst, int maxdst,
		cannawc *src, int srclen, cannawc key, int flags,
